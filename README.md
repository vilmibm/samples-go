...
- [**Cron Workflow**](./cron): Demonstrates a recurring Workflow
  ...
  and `GetLastCompletionResult` APIs which are used to pass information between executions. **Note that we
  recommend using Schedules instead of Cron Jobs.** Additional
